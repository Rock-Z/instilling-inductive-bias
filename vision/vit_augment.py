...
def main():
    ...
    resnet_configs = ViTConfig.from_pretrained("google/vit-base-patch16-224")
    ...
    model = ViTForImageClassification.from_pretrained("google/vit-base-patch16-224", config=resnet_configs, ignore_mismatched_sizes=True)

    training_args = TrainingArguments(output_dir="checkpoints/vit_16class_ft_augmentation",
                                    num_train_epochs=1,
                                    learning_rate=1e-3,
    ...
    trainer.train()
    trainer.save_model("checkpoints/vit_16class_ft_augmentation")
